---
title: "Minimal project of three Python web framework (Django Tornado and Flask) "
---

本文试图通过一个最小项目“hello, world”，对比三种主流Python web框架的基本功能和框架风格，
进一步探究为何这点代码就能够跑起来一个站点。

在一个刚安装完成的“空白”操作系统上建设一个能够输出“hello, world”的动态站点并非看起来那么简单，
这中间至少包含如下过程：
...
以上这些讨论，只涉及到了Django的使用层面，也就是说作为一个web开发者，使用这些接口就可以发开网站。
下面我们开始讨论Django是如何实现这些框架的。
